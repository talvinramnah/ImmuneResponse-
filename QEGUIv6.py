def gameCallFunc(quizScoreNew):
    ...
    def GameLoop(gameExit,black,white,red,blue,WBC_x,WBC_x_change,WBC_y,pathogen_y,pathogen_x,shade_of_blue,pathogen_width,
                 WBC_width,lives,score,livesMsg,scoreMsg,pathogen_speed,orange,green,pathogen2_x,pathogen2_y,pathogen3_y,pathogen3_x,roundNumber,mutation):
...
def create_table():
    cursor.execute("CREATE TABLE IF NOT EXISTS studentScores(quizScore INTEGER, GameHits INTEGER, Username TEXT)")
create_table()
...
TextFile.write('Question: what ty[e of protein does regulatory region produce \n')
